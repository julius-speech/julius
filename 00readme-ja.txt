...
Juliusはバージョン4.3.1より GitHub へ移行しました．
今後，最新のソースコード・各種実行キット・開発情報の公開・共有および
...
バージョン 4.4 ではいくつかのアップデートと新機能が追加されました．
新ツールとして "adintool-gui" と "binlm2arpa" が追加されました．
また，"mkbingram" では文字コード変換出力が行えます．
モジュールモードではクライアント切断時に落ちずに次のクライアント接続を
...
Julius に関するご質問・お問い合わせは，GitHub あるいは
